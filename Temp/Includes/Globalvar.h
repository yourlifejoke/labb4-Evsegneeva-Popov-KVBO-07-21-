...
#ifndef _BUR_1650020542_1_
#define _BUR_1650020542_1_
...
/* Variables */
_GLOBAL plcbit gAxis04_ModuleOk;
...
_GLOBAL plcbit ENABLED;
_GLOBAL plcbit but4;
_GLOBAL plcbit but3;
_GLOBAL plcbit but2;
_GLOBAL plcbit but1;
_GLOBAL plcbit BlinkingButton;
_GLOBAL plcbit LEDS[4];
_GLOBAL plcbit BUTTONS[4];
...
_GLOBAL plcbit ENABLEDBUTTON;
_GLOBAL signed short speedBtn;
